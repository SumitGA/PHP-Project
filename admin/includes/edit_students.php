...
<form action="process/process_modify_students.php" method="post" enctype="multipart/form-data" name="form1" id="form1">



  <table width="571" height="207" border="1">
    <tr>
      <th height="36" scope="row">Student Name</th>
...
<input type="submit" name="cmdsubmit" id="cmdsubmit" value="Modify Student" />
      </th>
    </tr>
  </table>
</form>
